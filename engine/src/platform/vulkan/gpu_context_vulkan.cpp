...
void Quack::GPUContextVulkan::CreateSurface() {
    if (glfwCreateWindowSurface(instance, 
                                static_cast<GLFWwindow*>(Application::GetInstance().GetWindow()->GetHandle()),
                                nullptr, &surface) != VK_SUCCESS) {
        throw std::runtime_error("failed to create window surface!");
    }
}

void Quack::GPUContextVulkan::PickPhysicalDevice() {
...
void Quack::GPUContextVulkan::CreateLogicalDevice() {
...
void Quack::GPUContextVulkan::CreateSwapChain() {
...
void Quack::GPUContextVulkan::CreateImageViews() {
